...
function eventissimo_eventData_field( $post ) {
    ...
    <table id='day'>
	    ...
	    <tr style='display:block;'>
		    ...
		    <td width="60px">
				<input  style="<?php echo $display; ?>" class="required"  type="text" name="ora_inizio" id="ora_inizio" value="<?php echo $ora_inizio; ?>"/>
			</td>       
        </tr>
        ...
        <tr id="hourfine" style="<?php echo $display; ?>">
		    ...
		    <td width="60px">
				<input type="text" name="ora_fine"   class="required" id="ora_fine" value="<?php echo $ora_fine; ?>"/>
		    </td>
        </tr>
