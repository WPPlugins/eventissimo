...
function getAPIFB() {
	...
	FB.api('/me/permissions', function (response) {
		...
		if((response["data"][0].create_event == 1) && (response["data"][0].user_events == 1) && (response["data"][0].publish_stream == 1) && (response["data"][0].photo_upload == 1) && (response["data"][0].rsvp_event == 1) && (response["data"][0].publish_actions == 1) && (response["data"][0].manage_pages == 1)) {
...
function loginFB() {
	...
	}, {scope:'create_event,publish_stream,photo_upload,user_events,publish_actions,rsvp_event,manage_pages'});
