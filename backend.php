            ...
            case 'import':
				...
				foreach ( $entry_id as $id ) {
					...
					$post = array(
					 ...
					 add_post_meta($the_post_id, 'colorRandom', $randomColor , true);
...
function eventissimo_fbupdating(){
	...
	if (FACEBOOOK_API_KEY!=""){
		...
		echo '<div id="message" class="error"><p>' . __( 'To view this page you need to set the app key and password of Facebook', 'eventissimo' ) . ' | <a href="edit.php?post_type=events&page=eventissimo_setting">' . __('Go to page','eventissimo') . '</a></p></div>';
	}
	echo '</div>';
}
